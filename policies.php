...
<img src="/policies.webp" alt="Foto ilustrativa de Políticas de Privacidade" width="300px">
<p><strong>A sua privacidade é importante para nós. É política do <em>Mulheres.Tech</em> respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <em>Mulheres.Tech</em>, e outros sites que possuímos e operamos.</strong></p>
    ...
    <h3>Política de Cookies <em>Mulheres.Tech</em></h3>
    ...
    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o <em>Mulheres.Tech</em> oferece no site e com caráter enunciativo, mas não limitativo:</p>
    <ol type="A">
        <li>Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;</li>&nbsp;
        <li>Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, casas de apostas ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>&nbsp;
        <li>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do <em>Mulheres.Tech</em>, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
    </ol>
    ...
    <p><em>Esta política é efetiva a partir de 28 de setembro de 2022 às 19:40.</em></p>
<?php
/*********************************************************
